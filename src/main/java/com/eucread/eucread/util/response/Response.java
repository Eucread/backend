...
public class Response<T> {
	...
	public static <T> Response<T> errorResponse(int status, String message) {
		Response<T> response = new Response<>();
		response.code = "VAL-001";
	...
	public static <T> Response<T> errorResponse(int status, String message, T data) {
		Response<T> response = new Response<>();
		response.code = "VAL-001";
		response.status = status;
		response.message = message;
